...
public class NewCategoryAgain extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sessionIntent = starterIntent.getStringExtra(ResultsActivity.SESSION_EXTRA);
        ...
        public void onClick(View v) {
            if (candidateEditText.getText().length() > 0) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(NewCategoryAgain.this);
    ...
    OnItemLongClickListener candidateLongClickListener = new OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(NewCategoryAgain.this);
